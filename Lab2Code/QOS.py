...
def create_quotapolicyrule(vserver_name: str, volume_name: str, qtree_name: str, space_hard_limit: int, file_hard_limit: int)-> None:
    ...
    data = {
        ...
        'file': [{'hard_limit':file_hard_limit},{'soft_limit':100}]
    }
...
if __name__ == "__main__":
    ...
    create_quotapolicyrule(args.vserver_name, args.volume_name, args.qtree_name, args.space_hard_limit, args.file_hard_limit)
